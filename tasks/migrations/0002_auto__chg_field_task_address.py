...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Task.address'
        db.alter_column(u'tasks_task', 'address', self.gf('django.db.models.fields.CharField')(max_length=2000))

    def backwards(self, orm):

        # Changing field 'Task.address'
        db.alter_column(u'tasks_task', 'address', self.gf('django.db.models.fields.CharField')(max_length=200))
